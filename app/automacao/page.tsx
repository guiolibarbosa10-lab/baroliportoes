  ...
  return (
    <div className="container-baroli py-16 lg:py-24">
      <Reveal>
        ...
        <h1 className="font-display text-5xl sm:text-6xl mb-6 max-w-3xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <Reveal>
          <h2 className="font-display text-3xl mb-8">Nossos serviços</h2>
        ...
        <Reveal delay={0.15}>
          <div className="border border-white/10 bg-baroli-gray-900 p-8">
            <h2 className="font-display text-3xl mb-6">Manutenção preventiva</h2>
