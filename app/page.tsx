    ...
    <>
      ...
      <section className="container-baroli py-24 lg:py-32">
        <Reveal>
          ...
          <h2 className="font-display text-4xl sm:text-5xl mb-16 max-w-2xl">
          ...
          {linhas.map((linha, i) => (
            <Reveal key={linha.valor} delay={i * 0.1}>
              <Link
                ...
                className="group block h-full border border-white/10 p-8 hover:border-baroli-blue transition-colors"
              >
                <span className="font-mono text-baroli-blue text-sm">
                  0{i + 1}
                </span>
                <h3 className="font-display text-3xl mt-4 mb-4">{linha.nome}</h3>
                <p className="text-white/60 text-sm leading-relaxed mb-8">
                  {linha.descricao}
                </p>
                <span className="text-xs uppercase tracking-widest2 text-white/50 group-hover:text-baroli-blue transition-colors">
                  Explorar modelos →
                </span>
              </Link>
            </Reveal>
      ...
      {/* DESTAQUES */}
      <section className="bg-baroli-gray-900/40 py-24 lg:py-32">
        <div className="container-baroli">
          <Reveal>
            <div className="flex items-end justify-between mb-14 flex-wrap gap-4">
              <div>
                <p className="eyebrow mb-4">Selecionados do catálogo</p>
                <h2 className="font-display text-4xl sm:text-5xl">Modelos em destaque</h2>
              </div>
              <Link
                href="/catalogo"
                className="text-sm uppercase tracking-widest2 border-b border-baroli-blue pb-1 hover:text-baroli-blue transition-colors"
              >
      ...
      <section className="container-baroli py-24 lg:py-32">
        <Reveal>
          <div className="relative overflow-hidden border border-white/10 px-8 py-16 lg:px-20 lg:py-24 text-center">
            <div className="absolute inset-0 bg-gradient-to-br from-baroli-blue/10 via-transparent to-transparent" />
            <p className="eyebrow mb-4 relative">Configurador de orçamento</p>
            <h2 className="font-display text-4xl sm:text-5xl mb-6 relative max-w-2xl mx-auto">
              Simule o investimento do seu portão em menos de 2 minutos
            </h2>
            <p className="text-white/60 max-w-xl mx-auto mb-10 relative">
              Escolha tipo, medidas, material e automação — receba uma estimativa
              e envie direto para o nosso WhatsApp.
            </p>
            <Link
              href="/calculadora"
              className="relative inline-block bg-baroli-blue px-10 py-4 text-sm uppercase tracking-widest2 hover:bg-baroli-blue-dark transition-colors"
            >
