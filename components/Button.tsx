...
const variantStyles: Record<ButtonVariant, string> = {
  primary: "bg-baroli-blue text-white hover:bg-baroli-blue-dark",
  secondary: "bg-baroli-gray-100 text-baroli-blue hover:bg-baroli-gray-200",
  outline: "border border-baroli-blue text-baroli-blue hover:bg-baroli-blue hover:text-white",
  ghost: "text-baroli-blue hover:bg-baroli-blue-50",
};
